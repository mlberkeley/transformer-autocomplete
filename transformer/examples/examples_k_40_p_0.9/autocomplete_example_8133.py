...
##################################################
  ...
  string* unused_name;
  TF_RETURN_IF_ERROR(
      EagerOp::SetDebugString(device_name_, nullptr, &unused_name));
  strings::StrAppend(&out, "Device:", Device()->DebugString(device_name_));
  string& debug_device_name_;
  TF_RETURN_IF_ERROR(
      device_name_.Contains(DeviceNameUtils::ParsedName(

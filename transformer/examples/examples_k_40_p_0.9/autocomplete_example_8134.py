...
_op =
      new EagerOperation;
    {NewOperation("T"), NewOperation("NewRegularizer")}}
    {new TestEagerOp},
      new EagerOperation;
  }

TEST(EagerOpRewriteRegistryTest, RegisterRewritePass_OptionalRetry) {
  ASSERT_EQ(0, TestEagerOpRewrite::count_);
  EagerOperation* orig_op = new EagerOperation;
    {NewOperation("T"), NewOperation("NewRegularizer")}}
    {new TestEagerOp},

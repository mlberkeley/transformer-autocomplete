...
##################################################
 ...
 class will be invoked after the op rewrite pass runs.
class RewriteRegistry : public EnvBase {
 public:
  RewriteRegistry();

  // Holds the pass registered for the given phase.
  static constexpr int32 kNumPhases = 1;
  static constexpr int32 kNumPhases = kNumPhases;
};

} // namespace eager_rewrite_registry

...
out);
    // Incompatible with std::string; should be
    TF_RETURN_IF_ERROR(status);
    string DebugStringValue(string out_, DataType string,
                              std::string status) const override {
      if (!Status::IsFinal())
        TF_RETURN_IF_ERROR(std::make_pair(status.code(), status.error_message(),

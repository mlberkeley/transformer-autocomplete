...
##################################################
  ...
  TensorHandle* shape_tensor = nullptr;
  TF_RETURN_IF_ERROR(ic->GetAttr("in", &shape_tensor));

  TensorHandle* inputs_tensor = nullptr;
  TF_RETURN_IF_ERROR(ic->GetAttr("in", &inputs_tensor));

  TF_RETURN_IF_ERROR(ic->AddInput(inputs, input_tensor->tensor));

  ShapeHandle* out_shape = nullptr;
  TF_RETURN_IF_ERROR(ic->ShapeHandle(inputs_tensor->shape, &out_shape));

  std::vector<TensorHandle> inputs(size_t

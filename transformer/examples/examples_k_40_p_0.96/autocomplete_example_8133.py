...
string EagerOperation::DeviceNameUtils::ParseFullName(const char* device,
                                                              string* debug_device_name) const {
  const char kDeviceNumPyBytes = kFullName;
  const char kDumpedName = (k

...
const std::unordered_map<int, FunctionType>& func,
                            DeviceMgr* handle,
                            Eager* result_handle)
      : DoneCallback(handle) {}

  ~EagerProcessFunctionLibraryRuntime() override {}

  Status SaveProto(bool status) override {}

  Status Run(void* result, const FunctionType& function_type) override {}

  void UpdateExecutorArgs(const std::unordered_map<int, FunctionType>& args) override;
...
// Required for is_platform_available_eager_function

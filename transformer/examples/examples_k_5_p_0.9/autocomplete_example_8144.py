...
Status AttrTypeMapForOp(const char* op_name,
                       const AttrTypeMap* in,
                         const AttrTypeMap** out) {
  // If the attr_type attribute is not defined, use a new attr_type
  // for this op.
  AttrTypeMap* attr_type;

...
##################################################
  ...
  // Populates the returned KernelAndDevice.
  virtual Status Populate(const NodeDef& ndef, GraphCollector* graph_collector) = 0;
  ...
  // Create a new thread to execute the computation.
  //
  // TODO

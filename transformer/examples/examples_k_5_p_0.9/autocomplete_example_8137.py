...
##################################################
 ...
 AsyncEagerNode<TensorHandle> {
 public:
  AsyncEagerNode() {}

  virtual ~AsyncEagerNode() {}
 ...
 private:
  ...
  // Called when this node will not be run due to some error contained in
  // `status`. `status` must not be OK.
  // For example, if the node would have computed some tensors in the
  // Run(), it should poison the corresponding tensor handles in this method.
  virtual void Abort() = 0;

  // Returns nullptr iff this AsyncEager node is synchronous.
  virtual AsyncEagerNode* AsAsync() { return nullptr; }

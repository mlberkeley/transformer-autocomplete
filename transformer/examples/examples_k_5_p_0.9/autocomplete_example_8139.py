...
class EagerDeviceOp : public OpKernel {
 public:
  EagerDeviceOp(OpKernelConstruction* ctx) : OpKernel(ctx) {
    OP_REQUIRES_OK(ctx, ctx->GetAttr("num_elements", &num_elements_));
  }

  void AddDevice(OpKernelContext* ctx) override {
    OP_REQUIRES_OK(ctx, ctx->GetAttr("num_elements", &num_elements_));
  }

 protected:
  Status CreateDevice(OpKernelContext* ctx,

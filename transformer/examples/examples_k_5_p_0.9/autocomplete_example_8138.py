...
##################################################
      ...
      if (has_thread) {
        // We are waiting for all pending threads to be closed.
        if (has_thread) {
          // We can't wait until the threads are all closed.
          if (has_thread) {
            // If all pending threads were all closed before we started,
            // we should not have started the next thread.
             // We should not have stopped the next thread.
              Status s =
                  Status::OK();
